  ...
  return (
    <footer>
      ...
      <div className=" py-4 bg-slate-700 text-white">
        <p className='text-normal text-center font-medium sm:text-lg sm:font-serif'>© Copyright 2022-2023 www.Servease.com All rights reserved. Developed by servase</p>
      </div>
